...
extern (C) {
  ...
  */
  ...
  @safe @nogc void poppler_page_render_selection(PopplerPage* page, cairo_t* cairo, PopplerRectangle* selection,
      PopplerRectangle* old_selection,
      PopplerSelectionStyle style, PopplerColor* glyph_color, PopplerColor* background_color) pure nothrow;
  ...
  deprecated("use poppler_page_get_selected_region") @safe @nogc GList* poppler_page_get_selection_region(
      PopplerPage* page, gdouble scale, PopplerSelectionStyle style, PopplerRectangle* selection) pure nothrow;
  deprecated("use cairo_region_destroy") @safe @nogc void poppler_page_selection_region_free(GList* region) pure nothrow;
  ...
  @safe @nogc gboolean poppler_page_get_text_layout(PopplerPage* page,
      PopplerRectangle** rectangles, guint* n_rectangles) pure nothrow;
  @safe @nogc gboolean poppler_page_get_text_layout_for_area(PopplerPage* page,
      PopplerRectangle* area, PopplerRectangle** rectangles, guint* n_rectangles) pure nothrow;
